...
<div style="position: absolute; top: 3%; left: 5%; width: 90%; height: 50px; border-radius: 30px; background-color: aquamarine; -webkit-animation: bgcolorchange 10s infinite;
animation: 10s infinite bgcolorchange;">
<marquee behavior="slide" scrollamount="5" loop="1" direction="down">
<div style="width: 99%; height: 50px; border-radius: 50px; -webkit-animation: bgcolorchange 4s infinite;
 animation: 2s infinite bgcolorchange; margin-left: 2px; margin-right: 2px; padding-top: 10px;">

<h5 style="text-align: center; width: 100%; color: rgb(92, 3, 3); cursor: pointer;">

 <a href="" style="padding-right: 2px; text-decoration: none; color: rgb(92, 3, 3)">Home</a>
 <a onclick="ElieCarReviewAbout()" style="padding: 10px;">About</a>
 <a href="" style="padding-right: 10px;"><img alt="Logo of Car Review" src="ElieCarReviewLogo.jpg"
     style="width: 80px; height: 30px; margin: 0%; padding: 0%; border-radius: 20px 20px 20px 10px;"></a>
 <a onclick="ElieCarReviewBusiness()" style="padding-right: 10px;">Business</a>
 <a onclick="ElieCarReviewContact()">Contact</a>
</h5>
</div>
</marquee>
</div>

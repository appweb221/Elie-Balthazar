const ElieCarReviewNav = `<div class="d-none d-lg-block" style="position: absolute; width: 100%; height: 50px; border-radius: 30px; background-color: aquamarine; -webkit-animation: bgcolorchange 10s infinite;
  ...
  <nav class="navbar bg-body-tertiary fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="">
        <div style="border-radius: 100%; padding: 5px; -webkit-animation: bgcolorchange 4s infinite;
      animation: 2s infinite bgcolorchange;">
          <div
            style="background-image: url(ElieCarReviewLogo.jpg); background-size: 100%; border-radius: 100%; padding: 15px; color: rgb(92, 3, 3);">
            <h5 style="text-align: center; padding: 5px 5px 0px 5px; margin: 0%;">All the Elie</h5>
            <h6 style="text-align: center; margin: 0%;">BUSINESS</h6>
          </div>
        </div>
      </a>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="offcanvasNavbarLabel">All the Elie in one place</h5>
          <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body" style="cursor: pointer;">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" onclick="ElieCarReviewAbout()">About</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" onclick="ElieCarReviewIndustry()">Car Industry</a></li>
                <li><a class="dropdown-item" onclick="ElieCarReviewRealEstate()">Real Estate</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" onclick="ElieCarReviewEBC()">Eddy Baltthazar College</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link" onclick="ElieCarReviewContact()">Contact</a>
            </li>
          </ul>
...
function ElieCarReviewAbout() {
  ...
  animation: 2s infinite bgcolorchange;"><form><div><br><br><div><marquee behavior="scroll" scrollamount="15" direction="left"><h5>About</h5></marquee></div><br><div><h4 style="text-align: center;">
  <audio controls>
      <source src="ElieCarReviewAbout.mp3" type="audio/mpeg">
      <source src="ElieCarReviewAbout.ogg" type="audio/ogg">
    </audio> 
  </h4></div><br><div><h6>All the Elie Balthazar Business is the official page of Elie Balthazar which connects users with the car industry service. We understand that it is not good behavior to buy things you do not know, so the car industry is divided in two sections. The first section is a Car Review which helps to understand a car based on the model and its features. Now when you know the car and its features, we connect you with dealerships all around the USA to find your car and whenever we recommend you to a dealership, you will be beneficiate with special attention from customer services and discount. So for the Real Estate service. We explain to you the meaning of having a house, what to look for when you are buying a house.</h6></div>
<br><br>
<div><h6>All the Elie Bathazar in one place also connect you with the foundation of Elie Balthazar, and if you are a parent or a student of Eddy Balthazar College you already have a special account to log in, to have access to all the information available to you as teacher, parent or student (Course, scholarship, certificate, etc.).</h6></div>
<br><br>
<div><h6>We do not focus only on doing business with our users, but we have special workshops for them to release their potential. Sometimes you listen to a very pessimistic mind saying: “You are all out to say pay people, they can accomplish anything.” The answer to this negative thought is: “Yes, we are all out to say people, they can accomplish anything.” And the question to this negative mind is: “Do you want us to take people to the pessimism side of life to take away motivation?” We understand that you have to help other just like we receive help in the pass. We were fortunate to be professional in all the areas we are developing ourselves and also, with the help of so many motivational speakers, the challenges of life do not defeat us until today.</h6></div></div></form></div>${ElieCarReviewFooter}`
};
...
function ElieCarReviewCreateAnAccount() {
  document.body.innerHTML = `${ElieCarReviewNav}<div style="background-color: white; padding: 30px; border-radius: 30px; -webkit-animation: bgcolorchange 4s infinite;
  animation: 2s infinite bgcolorchange;"><form style="text-align: center"><fieldset>
...
function ElieCarReviewUnlock() {
  document.body.innerHTML = `${ElieCarReviewNav}<div style="background-color: white; padding: 30px; border-radius: 30px;> <div>
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/YDc74e2BJY0?si=wbmrOHqJhyXwgWX7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  <br><br>
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    ...
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
      <form style="text-align: center"><fieldset>
          <legend style="text-align: center;">Select the right answer:</legend>
        ...
        <br><br><br>
        <br>
        <label for="answer"><b>Should we read and listen to any kind of texts and speeches?</b></label>
